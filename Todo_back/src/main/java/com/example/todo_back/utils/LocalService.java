package com.example.todo_back.utils;
...
public abstract class LocalService<T1, T2> {
    ...
    protected IndexAndValue<T1> findByProperty(T2 value) throws ResourceNotFoundException {
        try {
            ...
            Class<?> classA = objects.get(0).getClass();
            PropertyDescriptor propertyDescriptor = new PropertyDescriptor(getIdentifier(), classA);
            ...
            } else throw new ResourceNotFoundException(classA.getName(), value);
        } catch (Exception e) {
